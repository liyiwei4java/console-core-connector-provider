...
public class LocationController {
    @Autowired
    com.pccw.platform.provider.service.ServiceFactory serviceFactory;
    ...
    public ResultData<Entity> get(@PathVariable("provider") String provider,@PathVariable("id") String id) {
